            ...
            n("replace", 2, (function (e, t, o, n) {
                ...
                return [function (o, n) {
                    ...
                    while (1) {
                        ...
                        if (x.push(y), !h) break;
                        var _ = String(y[0]);
                        "" === _ && (s.lastIndex = c(m, a(s.lastIndex), R))
                    }
                    for (var A = "", k = 0, w = 0; w < x.length; w++) {
                        y = x[w];
                        for (var L = String(y[0]), U = f(p(r(y.index), m.length), 0), $ = [], O = 1; O < y.length; O++) $.push(b(y[O]));
                        var E = y.groups;
                        if (d) {
                            var N = [L].concat($, U, m);
                            void 0 !== E && N.push(E);
...
//# sourceMappingURL=chunk-1ffacd5c.a7be0b46.js.map