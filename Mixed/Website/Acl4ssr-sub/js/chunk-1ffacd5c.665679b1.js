    ...
    ["chunk-1ffacd5c"], {
            ...
            n("replace", 2, (function (e, t, o, n) {
                ...
                return [function (o, n) {
                    ...
                    for (var A = "", k = 0, w = 0; w < x.length; w++) {
                        y = x[w];
                        for (var L = String(y[0]), U = p(f(r(y.index), m.length), 0), $ = [], O = 1; O < y.length; O++) $.push(b(y[O]));
                        var E = y.groups;
                        if (d) {
                            var N = [L].concat($, U, m);
                            void 0 !== E && N.push(E);
                        ...
                        U >= k && (A += m.slice(k, U) + T, k = U + L.length)
                    }
                    return A + m.slice(k)
                }];
                ...
                function C(e, o, n, l, i, r) {
                    var s = n + e.length,
                        c = l.length,
                        u = h;
                    return void 0 !== i && (i = a(i), u = d), t.call(r, u, (function (t, a) {
                        var r;
                        switch (a.charAt(0)) {
                            case "$":
                                return "$";
        ...
        6547: function (e, t, o) {
            var n = o("a691"),
                ...
                a = function (e) {
                    return function (t, o) {
                        var a, i, r = String(l(t)),
                            s = n(o),
                            c = r.length;
                        return s < 0 || s >= c ? e ? "" : void 0 : (a = r.charCodeAt(s), a < 55296 || a > 56319 || s + 1 === c || (i = r.charCodeAt(s + 1)) < 56320 || i > 57343 ? e ? r.charAt(s) : a : e ? r.slice(s, s + 2) : i - 56320 + (a - 55296 << 10) + 65536)
                    }
                };
            e.exports = {
                codeAt: a(!1),
        ...
        9263: function (e, t, o) {
            ...
            p && (r = function (e) {
                var t, o, l, r, p = this,
                    ...
                    h = 0,
                    b = e;
                return f && (m = m.replace("y", ""), -1 === m.indexOf("g") && (m += "g"), b = String(e).slice(p.lastIndex), p.lastIndex > 0 && (!p.multiline || p.multiline && "\n" !== e[p.lastIndex - 1]) && (d = "(?: " + d + ")", b = " " + b, h++), o = new RegExp("^(?:" + d + ")", m)), u && (o = new RegExp("^" + d + "$(?!\\s)", m)), s && (t = p.lastIndex), l = a.call(f ? o : p, b), f ? l ? (l.input = l.input.slice(h), l[0] = l[0].slice(h), l.index = p.lastIndex, p.lastIndex += l[0].length) : p.lastIndex = 0 : s && l && (p.lastIndex = p.global ? l.index + l[0].length : t), u && l && l.length > 1 && i.call(l[0], o, (function () {
        ...
        a9c7: function (e, t, o) {
            ...
            var n = function () {
                    ...
                    return o("div", [o("el-row", {
                    ...
                    }, [e._v(e._s(e.backendVersion))])]), o("el-container", [o("el-form", {
                        staticStyle: {
                            width: "100%"
                        },
                        attrs: {
                        ...
                        on: {
                            click: function (t) {
                                e.uploadConfig = "", e.dialogUploadConfigVisible = !1
                            }
                        }
                ...
                l = [],
                a = (o("4de4"), o("c975"), o("b64b"), o("d3b7"), o("ac1f"), o("25f0"), o("5319"), "https://raw.githubusercontent.com/tindy2013/subconverter/master/base/config/example_external_config.ini"),
                i = "https://github.com/tindy2013/subconverter/releases",
                r = "https://api.wcc.best/sub?",
                s = "https://api.suo.yt/short",
                c = "https://api.wcc.best/config/upload",
                u = "",
                p = {
                    data: function () {
                        var e = {
                        ...
                        if (t) {
                            ...
                            for (var l = {}, i = Object.keys(e.options.customBackend), r = 0; r < i.length; r++) {
                                var s = i[r].replace(/\(.*/, "");
                    ...
                    created: function () {
                        document.title = "ACL4SSR 在线订阅转换", this.isPC = this.$getOS().isPc
                    },
                    mounted: function () {
                        this.form.clientType = "clash&new_name=true", this.form.customBackend = "https://subcon.py6.pw/sub?", this.form.remoteConfig = "https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online.ini", this.notify(), this.getBackendVersion()
                    },
                    methods: {
                        onCopy: function () {
                        ...
                        clashInstall: function () {
                            if ("" === this.customSubUrl) return this.$message.error("请先填写必填项，生成订阅链接"), !1;
                        ...
                        makeUrl: function () {
                            var e = this;
                            if ("" === this.form.sourceSubUrl || "" === this.form.clientType) return this.$message.error("订阅链接与客户端为必填项"), !1;
                            var t = "" === this.form.customBackend ? r : this.form.customBackend,
                        ...
                        confirmUploadConfig: function () {
                            ...
                            this.loading = !0;
                            var t = new FormData;
                            t.append("password", this.uploadPassword), t.append("config", this.uploadConfig), this.$axios.post(c, t, {
                                header: {
                                    "Content-Type": "application/form-data; charset=utf-8"
                                }
                            }).then((function (t) {
                        ...
                        getBackendVersion: function () {
                            var e = this;
                            this.$axios.get(r.substring(0, r.length - 5) + "/version").then((function (t) {
                                e.backendVersion = t.data.replace(/backend\n$/gm, ""), e.backendVersion = e.backendVersion.replace("subconverter", "")
                            }))
                        }
                    }
                },
                f = p,
                m = o("2877"),
                d = Object(m["a"])(f, n, l, !1, null, null, null);
            t["default"] = d.exports
        },
        ac1f: function (e, t, o) {
            "use strict";
            ...
            e.exports = function (e, t, o, p) {
                var d = a(e),
                    ...
                    b = h && !l((function () {
                        var t = !1,
                            o = /a/;
                        return "split" === e && (o = {}, o.constructor = {}, o.constructor[s] = function () {
                            return o
                        }, o.flags = "", o[d] = /./ [d]), o.exec = function () {
                            return t = !0, null
                        }, o[d](""), !t
                    }));
                if (!h || !b || "replace" === e && (!c || !u || f) || "split" === e && !m) {
                    var S = /./ [d],
                        ...
                        v = g[0],
                        C = g[1];
                    n(String.prototype, e, v), n(RegExp.prototype, d, 2 == t ? function (e, t) {
...
//# sourceMappingURL=chunk-1ffacd5c.665679b1.js.map