            ...
            n("replace", 2, (function (e, t, o, n) {
                ...
                return [function (o, n) {
                    ...
                    while (1) {
                        ...
                        if (x.push(_), !h) break;
                        var y = String(_[0]);
                        "" === y && (s.lastIndex = c(m, a(s.lastIndex), R))
                    }
                    for (var A = "", k = 0, w = 0; w < x.length; w++) {
                        _ = x[w];
                        for (var L = String(_[0]), U = f(p(r(_.index), m.length), 0), O = [], $ = 1; $ < _.length; $++) O.push(b(_[$]));
                        var E = _.groups;
                        if (d) {
                            var N = [L].concat(O, U, m);
                            void 0 !== E && N.push(E);
                            var T = String(n.apply(void 0, N))
                        } else T = C(L, m, U, O, E, n);
                ...
                function C(e, o, n, l, a, r) {
                    var s = n + e.length,
                        c = l.length,
                        u = h;
                    return void 0 !== a && (a = i(a), u = d), t.call(r, u, (function (t, i) {
                        var r;
                        switch (i.charAt(0)) {
                            case "$":
                                return "$";
        ...
        9263: function (e, t, o) {
            ...
            f && (r = function (e) {
                var t, o, l, r, f = this,
                    ...
                    h = 0,
                    b = e;
                return p && (m = m.replace("y", ""), -1 === m.indexOf("g") && (m += "g"), b = String(e).slice(f.lastIndex), f.lastIndex > 0 && (!f.multiline || f.multiline && "\n" !== e[f.lastIndex - 1]) && (d = "(?: " + d + ")", b = " " + b, h++), o = new RegExp("^(?:" + d + ")", m)), u && (o = new RegExp("^" + d + "$(?!\\s)", m)), s && (t = f.lastIndex), l = i.call(p ? o : f, b), p ? l ? (l.input = l.input.slice(h), l[0] = l[0].slice(h), l.index = f.lastIndex, f.lastIndex += l[0].length) : f.lastIndex = 0 : s && l && (f.lastIndex = f.global ? l.index + l[0].length : t), u && l && l.length > 1 && a.call(l[0], o, (function () {
        ...
        a9c7: function (e, t, o) {
            ...
            var n = function () {
                ...
                m = {
                                ...
                                options: {
                                    ...
                                    remoteConfig: [{
                                        ...
                                        options: [{
                                            ...
                                            label: "ACL4SSR_Online_Ful_MultiMode.ini 全分组 多模式 重度用户使用(与Github同步)",
                                            value: "https://raw.githubusercontent.com/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online_Ful_MultiMode.ini"
                                        }, {
                    ...
                    mounted: function () {
                        this.form.clientType = c, this.form.customBackend = s, this.form.remoteConfig = a, this.notify(), this.getBackendVersion()
                    },
                    methods: {
                        onCopy: function () {
...
//# sourceMappingURL=chunk-1ffacd5c.3a334a83.js.map