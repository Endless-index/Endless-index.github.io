    ...
    ["chunk-1ffacd5c"], {
            ...
            n("replace", 2, (function (e, t, o, n) {
                ...
                return [function (o, n) {
                    ...
                    for (var y = "", k = 0, w = 0; w < x.length; w++) {
                        R = x[w];
                        for (var L = String(R[0]), U = f(d(a(R.index), m.length), 0), O = [], $ = 1; $ < R.length; $++) O.push(b(R[$]));
                        var E = R.groups;
                        if (p) {
                        ...
                        U >= k && (y += m.slice(k, U) + M, k = U + L.length)
                    }
                    return y + m.slice(k)
                }];
                ...
                function C(e, o, n, l, r, a) {
                    var s = n + e.length,
                        c = l.length,
                        u = h;
                    return void 0 !== r && (r = i(r), u = p), t.call(a, u, (function (t, i) {
                        var a;
                        switch (i.charAt(0)) {
                            case "$":
                                return "$";
        ...
        6547: function (e, t, o) {
            var n = o("a691"),
                ...
                i = function (e) {
                    return function (t, o) {
                        var i, r, a = String(l(t)),
                            s = n(o),
                            c = a.length;
                        return s < 0 || s >= c ? e ? "" : void 0 : (i = a.charCodeAt(s), i < 55296 || i > 56319 || s + 1 === c || (r = a.charCodeAt(s + 1)) < 56320 || r > 57343 ? e ? a.charAt(s) : i : e ? a.slice(s, s + 2) : r - 56320 + (i - 55296 << 10) + 65536)
                    }
                };
            e.exports = {
                codeAt: i(!1),
        ...
        9263: function (e, t, o) {
            ...
            f && (a = function (e) {
                var t, o, l, a, f = this,
                    ...
                    h = 0,
                    b = e;
                return d && (m = m.replace("y", ""), -1 === m.indexOf("g") && (m += "g"), b = String(e).slice(f.lastIndex), f.lastIndex > 0 && (!f.multiline || f.multiline && "\n" !== e[f.lastIndex - 1]) && (p = "(?: " + p + ")", b = " " + b, h++), o = new RegExp("^(?:" + p + ")", m)), u && (o = new RegExp("^" + p + "$(?!\\s)", m)), s && (t = f.lastIndex), l = i.call(d ? o : f, b), d ? l ? (l.input = l.input.slice(h), l[0] = l[0].slice(h), l.index = f.lastIndex, f.lastIndex += l[0].length) : f.lastIndex = 0 : s && l && (f.lastIndex = f.global ? l.index + l[0].length : t), u && l && l.length > 1 && r.call(l[0], o, (function () {
        ...
        a9c7: function (e, t, o) {
            ...
            var n = function () {
                ...
                m = {
                        ...
                        var e = {
                                ...
                                options: {
                                    ...
                                    customBackend: {
                                        ...
                                        "subconverter.herokuapp.com(subconverter作者提供2-稳定)": "https://subconverter.herokuapp.com/sub?",
                    ...
                    mounted: function () {
                        this.form.clientType = c, this.form.customBackend = s, this.form.remoteConfig = r, this.notify(), this.getBackendVersion()
                    },
                    methods: {
                        onCopy: function () {
            ...
            e.exports = function (e, t, o, f) {
                ...
                if (!h || !b || "replace" === e && (!c || !u || d) || "split" === e && !m) {
                    var S = /./ [p],
                        ...
                        v = g[0],
                        C = g[1];
                    n(String.prototype, e, v), n(RegExp.prototype, p, 2 == t ? function (e, t) {
...
//# sourceMappingURL=chunk-1ffacd5c.0e89e258.js.map